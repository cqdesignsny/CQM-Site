 ...
 *
 * Features:
 * - Contact form (Tally/Typeform integration)
 * - Map with address
    ...
    <div className="container mx-auto px-4 py-20">
      <div className="mx-auto mb-12 max-w-3xl text-center">
        ...
        <p className="text-lg text-muted-foreground">
          Ready to grow your business? Book a strategy call, request a free
          audit, or schedule a studio tour.
        </p>
      </div>
      ...
      <div className="grid gap-12 lg:grid-cols-2">
        ...
        <div className="space-y-8">
          ...
          {/* Calendly Embed */}
          <div>
            <h2 className="mb-4 text-2xl font-semibold">Book a Call</h2>
